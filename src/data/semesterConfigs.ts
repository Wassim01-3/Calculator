...
export const semesterConfigs: Record<string, SemesterConfig> = {
  ...
  '3com1': {
    subjects: [
      ...
      { ...createSubject('Technique du commerce international', 'td_exam', 1.5), optionalGroup: 'opt_com_s1' },
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1.5), optionalGroup: 'opt_com_s1' },
    ],
  },
  ...
  '3com2': {
    subjects: [
      ...
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1.5), optionalGroup: 'opt_com_s2' },
      { ...createSubject('Transport et Logistique Internationale', 'td_exam', 1.5), optionalGroup: 'opt_com_s2' },
    ],
  },
  ...
  '3lfin1': {
    subjects: [
      createSubject('Gestion Financière Internationale', 'td_exam', 1.5),
      createSubject('Gestion des Institutions Financières', 'td_exam', 1),
      createSubject("Econométrie Appliquée à la Finance", 'td_exam', 2),
      createSubject('Gestion de Portefeuille', 'td_exam', 2),
      createSubject('Études de cas en Finance', 'td_exam_50_50', 2.5),
      createSubject('Anglais financier 1', 'td_exam', 1),
      createSubject('Développement personnel 2', 'td_exam', 1.5),
      createSubject('Gestion de trésorerie', 'td_exam', 1.5),
      { ...createSubject('Finance islamique', 'td_exam', 2), optionalGroup: 'opt_fin_s1' },
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 2), optionalGroup: 'opt_fin_s1' },
    ],
  },
  ...
  '3lfin2': {
    subjects: [
      createSubject('Ingénierie Financière et Montages Financiers', 'td_exam', 2.5),
      createSubject('Politiques Financières de l’entreprise', 'td_exam', 2),
      createSubject('Contrôle de Gestion', 'td_exam', 2),
      createSubject("Projet de fin d'études", 'td_exam', 2.5),
      createSubject('Anglais financier 2', 'td_exam', 1),
      createSubject('Introduction au logiciel R', 'td_exam', 1.5),
      createSubject('Analyse technique et trading boursier', 'td_exam', 1.5),
      { ...createSubject('Techniques de prévision', 'td_exam', 2), optionalGroup: 'opt_fin_s2' },
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 2), optionalGroup: 'opt_fin_s2' },
    ],
  },
  ...
  '3lmk1': {
    subjects: [
      ...
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1), optionalGroup: 'opt_mk_s1' },
      { ...createSubject('Théorie de la décision', 'td_exam', 1.5), optionalGroup: 'opt_mk_s1' },
    ],
  },
  ...
  '3lmk2': {
    subjects: [
      ...
      { ...createSubject('Webmarketing', 'td_exam', 1.5), optionalGroup: 'opt_mk_s2' },
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1.5), optionalGroup: 'opt_mk_s2' },
    ],
  },
  ...
  '3lma1': {
    subjects: [
      ...
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1), optionalGroup: 'opt_ma_s1' },
      { ...createSubject('Méthodes Scientifiques de Gestion', 'td_exam', 1), optionalGroup: 'opt_ma_s1' },
    ],
  },
  ...
  '3lma2': {
    subjects: [
      ...
      { ...createSubject('Business Game', 'td_exam', 1), optionalGroup: 'opt_ma_s2' },
      createSubject("Techniques d'aide à la décision", 'td_exam', 1.5),
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1), optionalGroup: 'opt_ma_s2' },
    ],
  },
  ...
  '3ing1': {
    subjects: [
      ...
      createSubject('Business English', 'td_exam', 1),
      createSubject('Développement personnel', 'td_exam', 1.5),
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1.5), optionalGroup: 'opt_ing_s1' },
      createSubject("Fondements et outils de l'ingénierie économique", 'td_exam', 2),
      { ...createSubject('Outils et logiciels statistiques', 'td_exam', 1.5), optionalGroup: 'opt_ing_s1' },
    ],
  },
  ...
  '3ing2': {
    subjects: [
      ...
      { ...createSubject('Gestion de portefeuille', 'td_exam', 1.5), optionalGroup: 'opt_ing_s2' },
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1.5), optionalGroup: 'opt_ing_s2' },
    ],
  },
  ...
  '3mon1': {
    subjects: [
      ...
      { ...createSubject('Gestion de trésorerie', 'td_exam', 1.5), optionalGroup: 'opt_mon_s1' },
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1.5), optionalGroup: 'opt_mon_s1' },
    ],
  },
  ...
  '3mon2': {
    subjects: [
      ...
      { ...createSubject('Marketing des produits bancaires et financiers', 'td_exam', 1.5), optionalGroup: 'opt_mon_s2' },
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1.5), optionalGroup: 'opt_mon_s2' },
    ],
  },
  ...
  '3lsc1': {
    subjects: [
      ...
      { ...createSubject("Organisation comptable et systèmes d'information", 'td_exam', 1), optionalGroup: 'opt_lsc_s1' },
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1), optionalGroup: 'opt_lsc_s1' },
    ],
  },
  ...
  '3lsc2': {
    subjects: [
      ...
      { ...createSubject("Techniques d'analyse de la conjoncture", 'td_exam', 1), optionalGroup: 'opt_lsc_s2' },
      createSubject('Contentieux et avantages fiscaux', 'td_exam', 1),
      { ...createSubject("Entreprise d'Entrainement Pédagogique", 'td_exam', 1), optionalGroup: 'opt_lsc_s2' },
    ],
  },
};
...
export const specializationsByYear: Record<string, { id: string; name: string; icon: string }[]> = {
  ...
  '3': [
    ...
    { id: 'lsc', name: 'Licence Sciences Comptables', icon: '📝' },
    { id: 'leb', name: 'E-Business', icon: '🌍' },
    { id: 'com', name: 'Commerce et finance internationale', icon: '💼' },
    { id: 'lfin', name: 'Finance', icon: '💵' },
    { id: 'lmk', name: 'Marketing', icon: '📢' },
    { id: 'lma', name: 'Management', icon: '👥' },
    { id: 'ing', name: 'Ingénierie économique et Financière', icon: '⚙️' },
    { id: 'mon', name: 'Monnaie-Finance, Banque et Assurance', icon: '🏦' },
  ],
};
